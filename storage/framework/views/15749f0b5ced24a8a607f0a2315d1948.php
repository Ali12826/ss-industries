...
<?php $__env->startSection('content'); ?>
    <div class="bg-ss-blue text-white text-center py-5" style="background: linear-gradient(135deg, #0056b3 0%, #002a5c 100%);">
        <div class="container py-5">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="btn btn-light text-primary btn-lg rounded-pill px-5 mt-3 fw-bold">Get in Touch</a>
        </div>
    </div>
    ...
    <div class="container my-5">
        <div class="row align-items-center">
            <div class="col-md-6">
                <img src="<?php echo e(asset('images/logo.png')); ?>" class="img-fluid p-5" alt="SS Industries Logo">
            </div>
            <div class="col-md-6">
                ...
                <a href="<?php echo e(route('about')); ?>" class="btn btn-primary mt-3">Read More About Us</a>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ss-industries/resources/views/home.blade.php ENDPATH**/ ?>