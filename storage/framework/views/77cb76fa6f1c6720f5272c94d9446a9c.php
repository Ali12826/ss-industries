...
<head>
    ...
    <title>SS Industries - <?php echo $__env->yieldContent('title', 'Pharmaceutical Excellence'); ?></title>
    ...
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="<?php echo e(route('home')); ?>">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="SS Industries">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item ms-lg-3">
                        <a class="nav-link btn-contact" href="<?php echo e(route('contact')); ?>">Contact Us</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <footer>
        <div class="container">
            ...
            <div class="footer-bottom text-center">
                <p class="mb-0">&copy; <?php echo e(date('Y')); ?> SS Industries. Under the visionary leadership of <strong>Dr. Jabeen Amin</strong>.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ss-industries/resources/views/layouts/app.blade.php ENDPATH**/ ?>